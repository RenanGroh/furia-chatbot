...
import { curiosidadeCommand, curiosidadePorUsuario } from './commands/curiosidades';

const bot = new Telegraf(process.env.BOT_TOKEN!);

bot.start(startCommand);
bot.command('jogadores', jogadoresCommand);
bot.command('proximojogo', proximoJogoCommand);
bot.command('curiosidade', curiosidadeCommand);
//Actions
