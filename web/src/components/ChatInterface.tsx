...
interface ChatInterfaceProps {
  messages: Message[]; // Recebe de ChatPage (que recebeu de App)
  setMessages: React.Dispatch<React.SetStateAction<Message[]>>; // Recebe de ChatPage
}
...
const ChatInterface: React.FC<ChatInterfaceProps> = ({
  ...
  }, [messages]); // Depende das messages recebidas por props
